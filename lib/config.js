import { Utils, ABSOLUTELY-DEAZLApi } from '@neoxr/wb'
global.Api = new ABSOLUTELY-DEAZLApi('https://api.neoxr.my.id/api', process.env.API_KEY)

import { createRequire } from 'module'
const require = createRequire(import.meta.url)

global.header = `© Absolutely Deazl Bot v${require('../package.json').version}`
global.footer = `ᴀʙsᴏʟᴜᴛᴇʟʏ ᴅᴇᴀᴢʟ ʙᴏᴛ ッ`
